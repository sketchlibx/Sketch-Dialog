...
Now featuring a Multi-Module architecture, you can choose between our Simple design or the new Material Design 3 (M3), along with a stunning new Glassmorphism effect and Custom View support!
...
* **🧩 Custom View Support:** Inject your own layouts seamlessly into the dialog while keeping the beautiful container and buttons intact.
...
dependencies {
    ...
    implementation 'com.github.sketchlibx.Sketch-Dialog:material:1.0.5'

    // For Simple/Classic Dialogs
    implementation 'com.github.sketchlibx.Sketch-Dialog:simple:1.0.5'
}
...
```
### 5. Custom Views
Need a custom input form, checkbox, or complex layout? Easily inject your own View into the dialog while keeping the beautiful container, blur effects, and buttons intact.
```java
...
new MaterialDialog.Builder(this)
    .setTitle("Subscribe")
    .setMessage("Enter your details below:")
    // Pass your custom View and a boolean indicating if it should be wrapped in a ScrollView
    .customView(customLayout, false) 
    .setPositiveButton("Submit", v -> {
...
```
### 6. Advanced Customization (Colors, Icons & Glassy Mode)
