...
* ⏳ **Progress Indicators:** Built-in support for Spinners, Horizontal, and Circular progress bars.
...
dependencies {
    ...
    implementation 'com.github.sketchlibx.Sketch-Dialog:material:v1.0.1'
    
    // For Simple/Classic Dialogs
    implementation 'com.github.sketchlibx.Sketch-Dialog:simple:v1.0.1'
}
```
...
```java
// Set defaults for Material Dialogs
...
// Set defaults for Simple Dialogs
...
```java
new MaterialDialog progressDialog = new MaterialDialog.Builder(this)
...
```java
new MaterialDialog.Builder(this)
    .setTheme(MaterialDialog.Theme.DARK) // Forces Dark Mode regardless of system settings
    .setAnimation(MaterialDialog.Animation.ZOOM) // Overrides global animation
    .setIcon(android.R.drawable.ic_dialog_alert)
    .setIconTint(Color.WHITE) // Custom Icon Tinting
